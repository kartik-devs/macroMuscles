...
export default function LegsWorkout({ navigation }) {
  const [exercises, setExercises] = useState([
    {
      id: '1',
      name: 'Barbell Squat',
      sets: [{ weight: 60, reps: 12, completed: false }],
      maxReps: 15,
      muscle: 'quads',
    },
    {
      id: '2',
      name: 'Leg Press',
      sets: [{ weight: 120, reps: 12, completed: false }],
      maxReps: 15,
      muscle: 'quads',
    },
    {
      id: '3',
      name: 'Leg Extension',
      sets: [{ weight: 40, reps: 15, completed: false }],
      maxReps: 20,
      muscle: 'quads',
    },
    {
    ...
    },
    {
      id: '5',
      name: 'Leg Curl',
      sets: [{ weight: 35, reps: 12, completed: false }],
      maxReps: 15,
      muscle: 'hamstrings',
    },
    {
      id: '6',
      name: 'Glute Bridge',
      sets: [{ weight: 0, reps: 15, completed: false }],
      maxReps: 20,
      muscle: 'glutes',
    },
  ]);
  ...
  const [newExerciseMuscle, setNewExerciseMuscle] = useState('quads');
  ...
  const quadsExercises = exercises.filter(ex => ex.muscle === 'quads');
  const hamstringsExercises = exercises.filter(ex => ex.muscle === 'hamstrings');
  const glutesExercises = exercises.filter(ex => ex.muscle === 'glutes');
    ...
    <View key={exercise.id} style={styles.exerciseCard}>
      <View style={styles.exerciseHeader}>
        <View style={styles.exerciseNameContainer}>
          <View style={[styles.muscleDot, { backgroundColor: exercise.muscle === 'quads' ? '#42A5F5' : exercise.muscle === 'hamstrings' ? '#8D6E63' : '#E91E63' }]} />
    ...
    <SafeAreaView style={styles.container}>
      ...
      {!workoutStarted ? (
        <View style={styles.startSection}>
          <Image 
            source={require('../../assets/shirtless.jpg')} 
            style={styles.workoutImage} 
            resizeMode="cover"
          />
          <View style={styles.workoutInfoContainer}>
            <Text style={styles.workoutInfoTitle}>Legs Workout</Text>
            <Text style={styles.workoutInfoText}>
              A complete lower body workout targeting quads, hamstrings, and glutes.
              {'\n\n'}
              • 6 exercises
              {'\n'}
          ...
          <View style={styles.workoutContainer}>
            ...
            <View style={styles.muscleSection}>
              <View style={styles.muscleTitleContainer}>
                <View style={[styles.muscleDot, { backgroundColor: '#42A5F5' }]} />
                <Text style={styles.muscleTitle}>QUADS</Text>
              </View>
              {quadsExercises.map(renderExerciseCard)}
            </View>
            {/* Hamstrings Section */}
            <View style={styles.muscleSection}>
              <View style={styles.muscleTitleContainer}>
                <View style={[styles.muscleDot, { backgroundColor: '#8D6E63' }]} />
                <Text style={styles.muscleTitle}>HAMSTRINGS</Text>
              </View>
              {hamstringsExercises.map(renderExerciseCard)}
            </View>
            {/* Glutes Section */}
            <View style={styles.muscleSection}>
              <View style={styles.muscleTitleContainer}>
                <View style={[styles.muscleDot, { backgroundColor: '#E91E63' }]} />
                <Text style={styles.muscleTitle}>GLUTES</Text>
              </View>
              {glutesExercises.map(renderExerciseCard)}
            </View>
              ...
              <View style={styles.muscleTypeButtons}>
                <TouchableOpacity 
                  style={[
                    ...
                    newExerciseMuscle === 'quads' && styles.muscleTypeButtonActive
                  ]}
                  onPress={() => setNewExerciseMuscle('quads')}
                >
                  <Text style={[
                    styles.muscleTypeButtonText,
                    newExerciseMuscle === 'quads' && styles.muscleTypeButtonTextActive
                  ]}>Quads</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[
                    styles.muscleTypeButton, 
                    newExerciseMuscle === 'hamstrings' && styles.muscleTypeButtonActive
                  ]}
                  onPress={() => setNewExerciseMuscle('hamstrings')}
                >
                  <Text style={[
                    styles.muscleTypeButtonText,
                    newExerciseMuscle === 'hamstrings' && styles.muscleTypeButtonTextActive
                  ]}>Hamstrings</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[
                    styles.muscleTypeButton, 
                    newExerciseMuscle === 'glutes' && styles.muscleTypeButtonActive
                  ]}
                  onPress={() => setNewExerciseMuscle('glutes')}
                >
                  <Text style={[
                    styles.muscleTypeButtonText,
                    newExerciseMuscle === 'glutes' && styles.muscleTypeButtonTextActive
                  ]}>Glutes</Text>
                </TouchableOpacity>
              </View>
            </View>
