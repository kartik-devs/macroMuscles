...
export default function ChestBackWorkout({ navigation }) {
  const [exercises, setExercises] = useState([
    {
      id: '1',
      name: 'Bench Press',
      sets: [{ weight: 80, reps: 10, completed: false }],
      maxReps: 12,
      muscle: 'chest',
    },
    {
    ...
    },
    {
      id: '3',
      name: 'Cable Fly',
      sets: [{ weight: 15, reps: 15, completed: false }],
      maxReps: 20,
      muscle: 'chest',
    },
    {
    ...
    },
    {
      id: '6',
      name: 'Lat Pulldown',
      sets: [{ weight: 55, reps: 12, completed: false }],
      maxReps: 15,
      muscle: 'back',
    },
  ]);
  ...
  const chestExercises = exercises.filter(ex => ex.muscle === 'chest');
  const backExercises = exercises.filter(ex => ex.muscle === 'back');
    ...
    <View key={exercise.id} style={styles.exerciseCard}>
      <View style={styles.exerciseHeader}>
        <View style={styles.exerciseNameContainer}>
          <View style={[styles.muscleDot, { backgroundColor: exercise.muscle === 'chest' ? '#4A90E2' : '#50E3C2' }]} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Chest & Back</Text>
        <TouchableOpacity 
      ...
      {!workoutStarted ? (
        <View style={styles.startSection}>
          ...
          <View style={styles.workoutInfoContainer}>
            <Text style={styles.workoutInfoTitle}>Chest & Back Workout</Text>
            <Text style={styles.workoutInfoText}>
              A complete upper body workout targeting chest and back muscles.
              {'\n\n'}
              • 6 exercises
              {'\n'}
          ...
          <View style={styles.workoutContainer}>
            ...
            <View style={styles.muscleSection}>
              <View style={styles.muscleTitleContainer}>
                <View style={[styles.muscleDot, { backgroundColor: '#4A90E2' }]} />
                <Text style={styles.muscleTitle}>CHEST</Text>
              </View>
              {chestExercises.map(renderExerciseCard)}
            </View>
            {/* Back Section */}
            <View style={styles.muscleSection}>
              <View style={styles.muscleTitleContainer}>
                <View style={[styles.muscleDot, { backgroundColor: '#50E3C2' }]} />
                <Text style={styles.muscleTitle}>BACK</Text>
              </View>
              {backExercises.map(renderExerciseCard)}
            </View>
              ...
              <View style={styles.muscleTypeButtons}>
                <TouchableOpacity 
                  style={[
                    ...
                    newExerciseMuscle === 'chest' && styles.muscleTypeButtonActive
                  ]}
                  onPress={() => setNewExerciseMuscle('chest')}
                >
                  <Text style={[
                    styles.muscleTypeButtonText,
                    newExerciseMuscle === 'chest' && styles.muscleTypeButtonTextActive
                  ]}>Chest</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity 
                  style={[
                    styles.muscleTypeButton, 
                    newExerciseMuscle === 'back' && styles.muscleTypeButtonActive
                  ]}
                  onPress={() => setNewExerciseMuscle('back')}
                >
                  <Text style={[
                    styles.muscleTypeButtonText,
                    newExerciseMuscle === 'back' && styles.muscleTypeButtonTextActive
                  ]}>Back</Text>
                </TouchableOpacity>
              </View>
            </View>
