...
export default function ShouldersWorkout({ navigation }) {
  const [exercises, setExercises] = useState([
    {
      id: '1',
      name: 'Overhead Press',
      sets: [{ weight: 30, reps: 10, completed: false }],
      maxReps: 12,
      muscle: 'shoulders',
    },
    {
      id: '2',
      name: 'Lateral Raise',
      sets: [{ weight: 8, reps: 15, completed: false }],
      maxReps: 15,
      muscle: 'shoulders',
    },
    {
      id: '3',
      name: 'Front Raise',
      sets: [{ weight: 8, reps: 12, completed: false }],
      maxReps: 12,
      muscle: 'shoulders',
    },
    {
      id: '4',
      name: 'Rear Delt Fly',
      sets: [{ weight: 6, reps: 15, completed: false }],
      maxReps: 15,
      muscle: 'shoulders',
    },
    {
    ...
    <View key={exercise.id} style={styles.exerciseCard}>
      <View style={styles.exerciseHeader}>
        <View style={styles.exerciseNameContainer}>
          <View style={[styles.muscleDot, { backgroundColor: '#2980b9' }]} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Shoulders Workout</Text>
        <TouchableOpacity 
      ...
      {!workoutStarted ? (
        <View style={styles.startSection}>
          ...
          <View style={styles.workoutInfoContainer}>
            <Text style={styles.workoutInfoTitle}>Shoulders Workout</Text>
            <Text style={styles.workoutInfoText}>
              A focused workout targeting all three heads of the deltoid for stronger, more defined shoulders.
              {'\n\n'}
              • 6 exercises
              {'\n'}
